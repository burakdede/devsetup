...
├── .gitignore
├── README.md
├── dotfiles/                    cross-platform configs
│   ├── .bash_aliases
│   ├── .gitconfig
│   ├── .gitignore_global
│   ├── .p10k.zsh
...
│   └── .config/
│       ├── agents/
│       │   └── instructions.md  shared agent system prompt
│       ├── mise/
...
│   ├── dotfiles.sh              symlinks dotfiles/ and mac/configs/ into $HOME
│   ├── configs/.config/         macOS-only configs (alacritty, …)
│   ├── agents/agents.sh
│   ├── configure/configure.sh
│   ├── editor/editor.sh
│   ├── git/git.sh
│   ├── macos/os-defaults.sh
...
└── linux/
    ├── run.sh                   main entry point
    ├── versions.txt             pinned tool versions
    ├── dotfiles.sh              symlinks dotfiles/ into $HOME
    ├── agents/agents.sh
    ├── assets/wallpapers/       desktop and login wallpapers
    ├── configure/configure.sh
    ├── docs/                    extended Linux-specific docs
    ├── editor/editor.sh
    ├── git/git.sh
    ├── multiplexer/multiplexer.sh
    ├── scripts/
    │   ├── verify-install.sh
    │   └── verify-system-smoke.sh
    ├── sdk/sdk.sh
    ├── shell/shell.sh
    ├── system/
    │   ├── system.sh
